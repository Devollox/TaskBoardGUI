...
export default function Home() {
    ...
    useEffect(() => {
        ...
        if (typeof document !== 'undefined') {
            ...
            let block = document.getElementById('id1')
            ...
            fetch('https://api.github.com/repos/Devollox/TaskBoard/issues')
                ...
                .then((commits) => {
                    try {
                        for (let i = 0; i < Object.size(commits); i++) {

                            let getTitleRepos = `${commits[i].title}`
                            let textSpecification = getTitleRepos.slice(0, getTitleRepos.indexOf(': '))

                            let textColor = {     // объект
                                'UX/UI': '926df1',
                                'Database': '6fc5f3',
                                'Front-end': 'dbc575',
                                'Back-end': '5B67C2',
                            ...
                            */
                            ...
                            const specification = s => s.split(': ').slice(1).join(': ')

                            if (contains(arrSpecification, elementSpecification) === false) {
                            ...
                            setInterval(() => {
                                console.log(Object.size(commits))
                            }, 10000)
                    ...
                    `)
                        ...
                        console.log(commits, Object.size(commits))
